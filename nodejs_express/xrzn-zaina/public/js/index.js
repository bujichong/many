...
var an = [
	//0
	{"in":[
			{o:'.h3-title',fn : {css:{top:'-150px'}},fx:[{animate:{top:'35%'},during:600}]},
			{o:'.p-intro',fn : {css:{top:'-250px'},addClass:'p-now'},fx:[{animate:{top:'35%'},during:700}]},
			{o:'.p-quickC',fn : {css:{top:'-350px'},addClass:'p-now'},fx:[{animate:{top:'35%'},during:800}]},
			{o:'.mapbg',fx:[{animate:{opacity:1},during:500}]},
			{o:'.s-pot-1',fx:[{animate:{top:'50%',opacity:1},during:400,delay:500}]},
			{o:'.s-pot-2',fx:[{animate:{top:'50%',opacity:1},during:400,delay:600}]},
			{o:'.s-pot-3',fx:[{animate:{top:'50%',opacity:1},during:400,delay:700}]},
			{o:'.s-pot-4',fx:[{animate:{top:'50%',opacity:1},during:600,delay:700}]},
			{o:'.s-pot-5',fx:[{animate:{opacity:1},during:800,delay:700}]},
			{o:'.p-headerQuick',global:true,fx : [{animate:{marginRight:'-220px'}, during:800}]}
		],
		"out":[
			{o:'.h3-title',fx:[{animate:{top:'1220px'},during:700}]},
			{o:'.p-intro',fn : {removeClass:'p-now'},fx:[{animate:{top:'1250px'},during:600,delay:200}]},
			{o:'.p-quickC',fx:[{animate:{top:'1250px'},during:600,delay:400}]},
			{o:'.mapbg',fx:[{animate:{opacity:0},during:500,delay:700}]},
			{o:'.s-pot-1',fx:[{animate:{top:'45%',opacity:0},during:400,delay:200}]},
			{o:'.s-pot-2',fx:[{animate:{top:'45%',opacity:0},during:400,delay:200}]},
			{o:'.s-pot-3',fx:[{animate:{top:'45%',opacity:0},during:600,delay:200}]},
			{o:'.s-pot-4',fx:[{animate:{top:'45%',opacity:0},during:800,delay:200}]},
			{o:'.s-pot-5',fx:[{animate:{opacity:0},during:800,delay:200}]}
		]
	},
	//1
	{"in":[
			{o:'.h3-title',fn : {css:{marginLeft:'-100%'}},fx:[{animate:{marginLeft:'-450px'},during:900}]},
			{o:'.p-intro',fn : {css:{marginLeft:'110%'}},fx:[{animate:{marginLeft:'-444px'},during:900}]},
			//{o:'.s-flash-1',fx:[{animate:{top:'15%',opacity:1},during:500}]},
			{o:'.s-flash-2',fx:[{animate:{top:'15%',opacity:1}, during:500,delay:200}]},
			{o:'.s-flash-3',fx:[{animate:{opacity:1}, during:1200,delay:900,callback:function () {
				$('.s-flash-1').fadeOut();
				$('.s-flash-2').fadeOut();
			}}]},
			{o:'.p-pageThumb',global:true,fn : {addClass:'p-pageThumb-s2'}},
			{o:'.p-headerQuick',global:true,fx : [{animate:{marginRight:'0px'}, during:800}]}
		],
		"out":[
			{o:'.h3-title',fx:[{animate:{marginLeft:'100%'},during:600}]},
			{o:'.p-intro',fx:[{animate:{marginLeft:'-110%'},during:600}]},
			{o:'.s-flash-3',fx:[{animate:{opacity:0}, during:600}]},
			{o:'.p-pageThumb',global:true,fn : {removeClass:'p-pageThumb-s2'}}
		]
	},
	//2
	{"in":[
			{o:'.s-phone-1',fx:[{animate:{top:'15%'},during:600}]},
			{o:'.s-phone-2',fx:[{animate:{marginLeft:'-170px',opacity:1},during:800,delay:600}]},
			{o:'.h3-title',fx:[{animate:{marginLeft:'180px',opacity:1},during:600,delay:1300}]},
			{o:'.p-intro',fx:[{animate:{marginLeft:'180px',opacity:1},during:800,delay:1300}]},
			{o:'.p-headerQuick',global:true,fx : [{animate:{marginRight:'0px'}, during:800}]}
		],
		"out":[
			{o:'.h3-title',fx:[{animate:{marginLeft:'160px',opacity:0},during:400}]},
			{o:'.p-intro',fx:[{animate:{marginLeft:'160px',opacity:0},during:400,delay:100}]},
			{o:'.s-phone-2',fx:[{animate:{marginLeft:'-500px',opacity:0},during:600,delay:500}]},
			{o:'.s-phone-1',fx:[{animate:{top:'110%'},during:600,delay:1100}]}
		]
	},
	//3
	{"in" : [
			{o:'.h3-title',fx:[{animate:{marginTop:'0px',opacity:1},during:800}]},
			{o:'.p-footerC',fx:[{animate:{marginTop:'120px',opacity:1},during:1000,delay:200}]},
			{o:'.footer',fx:[{animate:{bottom:'0px'},during:1000}]},
			{o:'.p-headerQuick',global:true,fx : [{animate:{marginRight:'-220px'}, during:800}]}
		],
	"out" : [
			{o:'.h3-title',fx:[{animate:{marginTop:'10px',opacity:0},during:900}]},
			{o:'.p-footerC',fx:[{animate:{marginTop:'110px',opacity:0},during:600}]},
			{o:'.footer',fx:[{animate:{bottom:'-180px'}}]}
		]
	}
];
